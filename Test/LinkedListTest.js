...
describe('LinkedList', () => {
  ...
  it('should add items to tail', () => {
    ...
    assert.equal(myList.tail.value, 5, 'Add to tail not working')
  });

  it('should add items to head', () => {
    const myList = new LinkedList();
    myList.addToHead(1);
    myList.addToHead(2);
    myList.addToHead(3);
    ...
    assert.equal(myList.head.value, 5, 'Add to tail not working')
  });
